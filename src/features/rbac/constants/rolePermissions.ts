...
export const ROLE_PERMISSIONS: Record<UserRole, readonly Permission[]> = {
  ...
  teacher: ['school.view', 'academic.view', 'attendance.view', 'attendance.manage', 'reports.view'],
  class_teacher: ['school.view', 'academic.view', 'attendance.view', 'attendance.manage', 'reports.view'],
  subject_teacher: ['school.view', 'academic.view', 'attendance.view', 'attendance.manage', 'reports.view'],
  parent: [],
  guardian: [],
  learner: [],
  guest: [],
