...
export const ROLE_PERMISSIONS: Record<UserRole, readonly Permission[]> = {
  ...
  school_owner: ['school.view', 'school.manage', 'profile.view_any', 'profile.manage_any'],
  principal: ['school.view', 'school.manage', 'profile.view_any', 'profile.manage_any'],
  ...
  teacher: ['school.view'],
  class_teacher: ['school.view'],
  subject_teacher: ['school.view'],
  parent: [],
  guardian: [],
  learner: [],
  guest: [],
