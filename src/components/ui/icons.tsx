...
export function BuildingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M4 21h16" />
      <path d="M7.5 7h2M7.5 11h2M7.5 15h2M12.5 7h1M12.5 11h1M12.5 15h1" />
    </svg>
  );
}
...
export function UsersIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M15 14.2c2.3.4 4 2.3 4 5.3" />
    </svg>
  );
}
...
export function GearIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <circle cx="12" cy="12" r="3" />
      <path d="M19.4 13.5a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.5V19.9a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.9 1.7 1.7 0 0 0-1.5-1H4.1a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.9.3H10a1.7 1.7 0 0 0 1-1.5V4.1a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9V10a1.7 1.7 0 0 0 1.5 1h.1a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.6 1Z" />
    </svg>
  );
}
...
export function BookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M4 4.5A1.5 1.5 0 0 1 5.5 3H19a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H6.5A2.5 2.5 0 0 1 4 17.5v-13Z" />
...
export function WalletIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3 7.5A1.5 1.5 0 0 1 4.5 6h13A1.5 1.5 0 0 1 19 7.5V9h-3.5a3 3 0 0 0 0 6H19v1.5a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 3 16.5v-9Z" />
      <path d="M19 9h1.5A1.5 1.5 0 0 1 22 10.5v3a1.5 1.5 0 0 1-1.5 1.5H19" />
...
export function MegaphoneIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3 10v4a1 1 0 0 0 1 1h2l4.5 4.2a1 1 0 0 0 1.5-.9V5.7a1 1 0 0 0-1.5-.9L6 9H4a1 1 0 0 0-1 1Z" />
      <path d="M19 9a3 3 0 0 1 0 6" />
      <path d="M15 6.5a6.5 6.5 0 0 1 0 11" />
    </svg>
  );
}
...
export function ChatIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-3.8-.9L3 20l1.4-5.7A8.5 8.5 0 0 1 12.5 3 8.38 8.38 0 0 1 21 11.5Z" />
    </svg>
  );
}
